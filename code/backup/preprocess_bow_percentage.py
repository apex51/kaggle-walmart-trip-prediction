...
x_train = hstack((feat_train, m_train_department_buy, m_train_department_return, m_train_fineline_buy, m_train_fineline_return), 'csr')
x_test = hstack((feat_test, m_test_department_buy, m_test_department_return, m_test_fineline_buy, m_test_fineline_return), 'csr')
